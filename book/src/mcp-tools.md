...
the code-specialised `jina-embeddings-v2-base-code`, set
...
to see every supported model. The search query is restricted to rows tagged
with the active model — switching models won't produce cross-space cosine noise.
