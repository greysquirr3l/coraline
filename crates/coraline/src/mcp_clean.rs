...
//!
//! This module provides a JSON-RPC 2.0 server that exposes Coraline's code graph
//! analysis capabilities as MCP tools that can be used by Claude and other AI assistants.
